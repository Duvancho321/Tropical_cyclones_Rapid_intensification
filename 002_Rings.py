...
from fuction_tools import interpolate_trajectory,process_time_rings
...
if __name__ == '__main__':
    ...
    cluster = LocalCluster(n_workers=40, threads_per_worker=2, 
                           memory_limit='2GB',
                           #timeout=60,
                           dashboard_address=':0')
    ...
    procesados = ["WP262016", "WP062021", "WP102018", "EP112019", "WP202019", "WP262019", 
           "WP032018", "WP342018", "WP222019", "WP272017", "WP272015", "WP022016", 
           "WP022021", "WP252017", "WP132015", "WP162016", "WP262018"]
    trayectories = trayectories[~trayectories['ATCF_ID'].isin(procesados)]
    ...
    for hur_sel in trayectories['ATCF_ID'].unique():
        try:
            ...
            with ThreadPoolExecutor(max_workers=40) as executor:
                futures = list(executor.map(process_time_rings,
